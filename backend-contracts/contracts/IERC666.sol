...
interface IERC666 {
    ...
    event UpdateBorrower(uint256 indexed tokenId, address indexed borrower, uint256 collateralAmount, uint256 loanAmount, uint256 loanInterestAmount, uint256 loanPayableAmount, uint64 expires);
